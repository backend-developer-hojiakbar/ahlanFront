...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        const [objects, apartments, users, salesReport, monthlyPayments] = await Promise.all([
          objectsRes.json(),
          apartmentsRes.json(),
          usersRes.json(),
          salesReportRes.json(),
  ...
  // Properties tab uchun obyektlar ro‘yxati
  ...
  useEffect(() => {
    ...
    const fetchProperties = async () => {
      try {
        ...
        const [objects, apartments] = await Promise.all([objectsRes.json(), apartmentsRes.json()])
